...
static NSString * kContactPhone = @"contactPhone";
...
- (void)encodeWithCoder:(NSCoder *)encoder {
    ...
    [encoder encodeObject:self.contactPhone forKey:kContactPhone];
...
- (id)initWithCoder:(NSCoder *)decoder {
    ...
    self.supportsObaRealtimeApis = [decoder decodeBoolForKey:kSupportsObaRealtimeApis];
    self.contactPhone = [decoder decodeObjectForKey:kContactPhone];
