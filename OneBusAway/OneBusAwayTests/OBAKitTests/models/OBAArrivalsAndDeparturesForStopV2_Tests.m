//
//  OBAArrivalsAndDeparturesForStopV2_Tests.m
...
@interface OBAArrivalsAndDeparturesForStopV2_Tests : XCTestCase
@property(nonatomic,strong) OBAModelFactory *modelFactory;
@end

@implementation OBAArrivalsAndDeparturesForStopV2_Tests
