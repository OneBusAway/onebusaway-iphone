...
SWIFT_MODULE_NAMESPACE_PUSH("PromiseKit")
...
///   </li>
/// </ul>
- (void)catchOn:(dispatch_queue_t _Nonnull)q policy:(PMKCatchPolicy)policy execute:(void (^ _Nonnull)(NSError * _Nonnull))body;
