...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwipeCellKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// The <code>SwipeAction</code> object defines a single action to present when the user swipes horizontally in a table/collection item.
...
/// The <code>SwipeCollectionViewCell</code> class extends <code>UICollectionViewCell</code> and provides more flexible options for cell swiping behavior.
/// The default behavior closely matches the stock Mail.app. If you want to customize the transition style (ie. how the action buttons are exposed), or the expansion style (the behavior when the row is swiped passes a defined threshold), you can return the appropriately configured <code>SwipeOptions</code> via the <code>SwipeCollectionViewCellDelegate</code> delegate.
...
/// The default behavior closely matches the stock Mail.app. If you want to customize the transition style (ie. how the action buttons are exposed), or the expansion style (the behavior when the row is swiped passes a defined threshold), you can return the appropriately configured <code>SwipeOptions</code> via the <code>SwipeTableViewCellDelegate</code> delegate.
