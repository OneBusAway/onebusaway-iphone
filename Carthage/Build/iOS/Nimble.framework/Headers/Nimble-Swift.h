...
@interface NMBObjCMatcher (SWIFT_EXTENSION(Nimble))
+ (NMBObjCMatcher * _Nonnull)satisfyAnyOfMatcher:(NSArray<NMBObjCMatcher *> * _Nonnull)matchers SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface NMBObjCMatcher (SWIFT_EXTENSION(Nimble))
+ (NMBObjCMatcher * _Nonnull)allPassMatcher:(NMBObjCMatcher * _Nonnull)matcher SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface NMBObjCMatcher (SWIFT_EXTENSION(Nimble))
+ (NMBObjCMatcher * _Nonnull)beEmptyMatcher SWIFT_WARN_UNUSED_RESULT;
@end
