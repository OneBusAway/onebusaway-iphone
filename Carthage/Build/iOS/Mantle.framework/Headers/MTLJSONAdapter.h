...
/// primitive type.
///
/// If `objCType` matches id, the value transformer returned by
/// +transformerForModelPropertiesOfClass: is used instead.
///
/// The default implementation transforms properties that match BOOL
...
///            as it would be returned by the directive.
///
/// Returns a value transformer or nil if no transformation should be used.
